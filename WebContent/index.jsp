...
<html lang="en">
              ...
              <div class="col-md-5 no-padding">                
                <div class="aa-promo-left">
                  <div class="aa-promo-banner">                    
                    <img src="img/promo-banner-1.jpeg" alt="img"> <!-- style="width: 450px;height: 450px;" -->                   
              ...
              <div class="col-md-7 no-padding">
                <div class="aa-promo-right">
                  <div class="aa-single-promo-right">
                    <div class="aa-promo-banner">                      
                      <img src="img/promo-banner-3.jpeg" alt="img">                      
                      <div class="aa-prom-content">
      ...
      <div class="row">
        <div class="col-md-12">        
          <div class="row">
            ...
            <a href="#"><img src="img/fashion-banner.png" alt="fashion banner img"></a>
          </div>
          </div>
        </div>
      </div>
  ...
  $(function(){
	  ...
	  $.ajax({
			...
			success : function(response) {
				...
				$.each(response,function(i, item) {
					...
					'<a onclick="addToCart('+item.id+')" class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a><figcaption>'+
	  ...
	  function addToCart(productId){
			alert(productId);
			$("#addToCartShoppingCart").append('<li><a class="aa-cartbox-img" href="#"><img src="img/woman-small-2.jpg" alt="img"></a>'+
		    '<div class="aa-cartbox-info"><h4><a href="#">Product Name</a></h4><p>1 x $250</p>'+
