...
<html lang="en">
  <head>
    ...
    <title>Daily Shop | My Account</title>
                    ...
                    <div class="row">
                      <div class="col-md-3">
                        <div class="card" style="width: 18rem;">
                           <img class="card-img-top" src="img/trackmyorder.png" alt="Card image cap">
                           <div class="card-body">
                     ...
                     <div class="col-md-3">
                        <div class="card" style="width: 18rem;">
                           <img class="card-img-top" src="img/profilepic.png" alt="Card image cap">
                           <div class="card-body">
                      ...
                      <!-- <div class="col-md-2">
                        <div class="card" style="width: 18rem;">
                           <img class="card-img-top" src="img/addressicon.png" alt="Card image cap">
                           <div class="card-body">
                               <p class="card-text">Your Address</p>
                           </div>
                        </div>
                      </div> -->
                      <div class="col-md-3">
                        <div class="card" style="width: 18rem;">
                           <img class="card-img-top" src="img/loginandsecurity.png" alt="Card image cap">
                           <div class="card-body">
                               <p class="card-text">Login & Security</p>
                           </div>
                        </div>
                      </div>
                    </div>
