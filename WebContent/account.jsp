            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="aa-myaccount-register">                 
                 <h4>Register</h4>
                 <form action="" class="aa-login-form" id="registerFormId">
                    <label for="">Mobile or Email address<span>*</span></label>
                    <input id="registerformusername" type="text" placeholder="Mobile or email" name="username">
                    <label for="">Password<span>*</span></label>
                    <input id="registerformpassword" type="password" placeholder="Password" name="password">
                    <button type="submit" class="aa-browse-btn" id="registerButtonSubmitId">Register</button>                    
                  </form>
                </div>
              </div>
            </div>          
 ...
 <!-- / Cart view section -->
  ...
  $(function(){
	  ...
	  $.ajax({
		...
		$("#registerButtonSubmitId").click(function(e){
			 e.preventDefault();
		        var formData = {
